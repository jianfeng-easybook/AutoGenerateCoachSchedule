namespace AutoGenerateCoachSchedule.Models
{
    public class CoachSchedule
    {
        ...
        public int? CompanyPermitDetail_Id { get; set; }
        ...
        public decimal? Schedule_DiscountCSD { get; set; }
        public string? Schedule_DiscountTypeCSD { get; set; }
        public decimal? Schedule_Discount_TwoWayCSD { get; set; }
        public string? Schedule_DiscountType_TwoWayCSD { get; set; }

        public bool? Counter_Display { get; set; }
        public int? OTADisplay { get; set; }
        public bool? AllowKioskSellTicket { get; set; }
